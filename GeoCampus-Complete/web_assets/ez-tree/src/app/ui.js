...
export function setupUI(tree, environment, renderer, scene, camera, orbitControls, initialPreset) {
  ...
  header.innerHTML = `
    ...
    <h1 class="panel-title" style="font-size: 1.2rem; line-height: 1.2;">Simulation of trees that can be planted in the campus</h1>
    <p class="panel-subtitle">Plan and visualize reforestation</p>
  `;
