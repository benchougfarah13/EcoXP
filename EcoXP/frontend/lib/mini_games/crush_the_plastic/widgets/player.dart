...
import 'package:eco_collect/mini_games/crush_the_plastic/widgets/utils.dart';
...
class Player extends SpriteAnimationGroupComponent
    with HasGameRef<PlasticCrusher>, KeyboardHandler, CollisionCallbacks {
  String character;
  Player({
    position,
  ...
  void onCollisionStart(
    ...
    if (!reachedCheckpoint) {
      if (other is Collectible) other.collidedWithPlayer();
      if (other is Saw) _respawn();
      if (other is Enemy) other.collidedWithPlayer();
