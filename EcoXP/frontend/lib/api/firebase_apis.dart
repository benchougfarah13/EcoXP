...
// #############################################################################
  ...
  /// Fetches top ranked players by XP for the Elite Leaderboard
  Future<List<UserDataModel>> fetchTopRankedPlayersByXP() async {
    try {
      ...
      debugPrint('❌ Erreur fetchTopRankedPlayersByXP: $e');
      return [];
    }
  }
}
